...
<body>
    <div>
        ...
        <p>
            Click <a href="<%= VirtualPathUtility.ToAbsolute("~/api/Packages") %>">here</a> to view your packages.
        </p>
        <fieldset style="width:800px">
            ...
            Package Sources:
            <blockquote>
                <strong><%= Helpers.GetBaseUrl(Request.Url, Request.ApplicationPath) + "api" %></strong>
            </blockquote>
